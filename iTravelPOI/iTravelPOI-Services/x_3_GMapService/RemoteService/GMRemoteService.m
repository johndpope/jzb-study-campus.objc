...
- (instancetype) initWithEmail:(NSString *)email
    ...
    if ( self = [super init] ) {
        itemFactory!=nil ? self.itemFactory = itemFactory : [[GMSimpleItemFactory alloc] init];
...
// =====================================================================================================================
#pragma mark -
#pragma mark GMDataStorage-MAP CRUD Protocol methods
// ---------------------------------------------------------------------------------------------------------------------
- (id<GMMap>) createMapWithName:(NSString *)name errRef:(NSErrorRef *)errRef {

    [self _addItem:nil errRef:errRef];
    return nil;
}
