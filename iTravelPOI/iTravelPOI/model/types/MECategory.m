...
- (void)addPointsObject:(MEPoint *)value {    
...
- (void)removePointsObject:(MEPoint *)value {
    NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
...
- (void)addCategoriesObject:(MECategory *)value {    
    NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
...
- (void)removeCategoriesObject:(MECategory *)value {
    NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
...
- (void)addSubcategoriesObject:(MECategory *)value {    
    NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
...
- (void)removeSubcategoriesObject:(MECategory *)value {
    NSSet *changedObjects = [[NSSet alloc] initWithObjects:&value count:1];
