...
+ (GroupAndCount *) withGroup:(MGroup *)group {
    GroupAndCount *instance = [[GroupAndCount alloc] init];
    instance.group=group.objectID;
    instance.count=group.viewCount;
    return instance;
}
...
//---------------------------------------------------------------------------------------------------------------------
@implementation GroupsAndPoints

@synthesize groupsAndCounts = _groupsAndCounts;
@synthesize points = _points;

+ (GroupsAndPoints *) withGroupsAndCounts:(NSArray *)groupsAndCounts points:(NSMutableArray *)points {
    
    GroupsAndPoints *instance = [[GroupsAndPoints alloc] init];
    instance.groupsAndCounts=groupsAndCounts;
