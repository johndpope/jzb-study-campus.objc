...
//*********************************************************************************************************************
@interface VisualMapEditorViewController() <UITextFieldDelegate, UITextViewDelegate>
...
+ (UIViewController<EntityEditorViewController> *) startEditingMap:(MMap *)map
    ...
    if(map!=nil && delegate!=nil) {
        ...
        DDLogVerbose(@"Warning: VisualMapEditorViewController-startEditingMap called with nil Map or Delegate");
        return nil;
    }
}
